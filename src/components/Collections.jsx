...
const collections = [
  {
    ...
    tag: 'For Her',
    name: "Women's",
    img: `${import.meta.env.BASE_URL}collection-women.png`,
    wide: false,
  },
  {
    id: 'men',
    tag: 'For Him',
    name: "Men's",
    img: `${import.meta.env.BASE_URL}collection-men.png`,
    wide: false,
  },
  {
    id: 'children',
    ...
    name: "Children's",
    img: `${import.meta.env.BASE_URL}collection-children.png`,
    wide: false,
  },
  {
    id: 'gifting',
    ...
    img: `${import.meta.env.BASE_URL}collection-gifting.png`,
    wide: true,
  },
];
